...
class ListCountryItemsAdapter(var dataofMealCountryItems: MealItems, var my_context:Context,var fragmentManager: FragmentManager,var mealListener:MealFavButtonListener,var userID:String): RecyclerView.Adapter<ListCountryItemsAdapter.myviewholder>()
{
    ...
    override fun getItemCount(): Int {
        return dataofMealCountryItems.meals.size
    }

    override fun onBindViewHolder(holder: myviewholder, position: Int) {
        val meal = dataofMealCountryItems.meals.get(position)
